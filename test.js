(function() {
    ...
    const url = 'https://www.youtube.com/watch?v=xpdZBP7GJUA'; //a URL of an arbitrary live stream
    const chat_source = window.open(url, 'chat_source', 'left=0');
